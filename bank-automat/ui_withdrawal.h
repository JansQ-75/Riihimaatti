...
public:
    ...
    void setupUi(QWidget *Withdrawal)
    {
        ...
        label_w_header->setGeometry(QRect(80, 30, 191, 71));
        QFont font;
        ...
        btn_20e->setGeometry(QRect(80, 280, 150, 60));
        ...
        btn_60e->setGeometry(QRect(570, 210, 150, 60));
        ...
        btn_otherAmount->setGeometry(QRect(570, 370, 150, 60));
        ...
        label_balance->setGeometry(QRect(570, 120, 341, 61));
        QFont font2;
        ...
        label_ownerName->setGeometry(QRect(80, 120, 221, 131));
